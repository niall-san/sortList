...
void wordlistToFile(string listsDir, string outputDir){
  ...
  enumeratedVector = wordlistsToVector(listsDir);
...
vector<string> wordlistsToVector(string directory){
  ...
  cout << "Files found: " << fileNameVector.size() << endl;
  string line;
...
int main(int argc, char* argv[]){
  ...
  options.showOptions();
try{
  wordlistToFile(options.getDirectory(), options.getOutput());
} catch (int e){
